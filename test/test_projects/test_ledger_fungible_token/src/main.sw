...
abi TestToken {
    #[storage(read, write)]fn mint(to: Address, amount: u64);
    #[storage(read, write)]fn burn(from: Address, amount: u64);
    #[storage(read, write)]fn transfer_tokens(from: Address, to: Address, amount: u64);
    #[storage(read)]fn balance_of(owner: Address) -> u64;
    #[storage(read)]fn get_supply() -> u64;
}
